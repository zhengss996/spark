...
public class ElasticSearchOperate {
    ...
    public void testCreate() throws IOException {
        ...
        IndexResponse response = client.prepareIndex("hainiu_api", "users", "1")
                .setSource(
                        jsonBuilder()
                                .startObject()
                                    .field("username", "牛牛")
    ...
    public void testGet() throws IOException {
        GetResponse response = client.prepareGet("hainiu_api", "users", "1").get();
    ...
    public void testMultiGet() throws IOException {
        MultiGetResponse multiGetItemResponses = client.prepareMultiGet()
                .add("hainiu_api", "users", "1")
                .add("hainiu_api", "users", "2", "3")
                .add("news", "fulltext", "1")
                .get();
    ...
    public void testUpdate() throws Exception {
        ...
        updateRequest.index("hainiu_api");
    ...
    public void testDelete() {
        DeleteResponse response = client.prepareDelete("hainiu_api", "users", "1").get();
    ...
    public void testDeleteByQuery() {
        BulkByScrollResponse response =
                DeleteByQueryAction.INSTANCE.newRequestBuilder(client)
                        //指定查询条件
                        .filter(QueryBuilders.matchQuery("username", "海牛"))
                        //指定索引名称
                        .source("hainiu_api")
                        .get();
    ...
    public void testRange() {
        ...
        SearchResponse response = client.prepareSearch("hainiu_api").setQuery(qb).get();
    ...
    /**
     * curl -XPUT 'http://s1.hadoop:9200/player_info/player/1' -d '{ "name": "curry", "age": 29, "salary": 3500,"team": "war", "position": "pg"}'
     * curl -XPUT 'http://s1.hadoop:9200/player_info/player/2' -d '{ "name": "thompson", "age": 26, "salary": 2000,"team": "war", "position": "pg"}'
     * curl -XPUT 'http://s1.hadoop:9200/player_info/player/3' -d '{ "name": "irving", "age": 25, "salary": 2000,"team": "cav", "position": "pg"}'
     * curl -XPUT 'http://s1.hadoop:9200/player_info/player/4' -d '{ "name": "green", "age": 26, "salary": 2000,"team": "war", "position": "pf"}'
     * curl -XPUT 'http://s1.hadoop:9200/player_info/player/5' -d '{ "name": "james", "age": 33, "salary": 4000,"team": "cav", "position": "sf"}'
     */
    @Test
    ...
    public void testAgg1() {
        ...
        TermsAggregationBuilder teamAgg = AggregationBuilders.terms("team").field("player_count");
        //添加聚合器
...
//        }
    ...
    /**
     * select team as team_name, position, count(*) as pos_count from player group by team, position;
     */
    @Test
    ...
    /**
     * select team as team_name, max(age) as max_age from player group by team;
     */
    @Test
    ...
    /**
     * select team as team_name, avg(age) as avg_age, sum(salary) as total_salary from player group by team;
     */
    @Test
    ...
    /**
     * select team as team_name, sum(salary) as total_salary from player group by team order by total_salary desc;
     */
    @Test
