...
public class SparkHello {
    public static void main(String[] args) {
        SparkConf sparkhello = new SparkConf().setAppName("sparkhello").setMaster("local[6]");
        JavaSparkContext jsc = new JavaSparkContext(sparkhello);
        JavaRDD<String> textFile = jsc.textFile("D:\\tmp\\spark\\word.txt");
